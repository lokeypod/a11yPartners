      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="pr-5 text-xl leading-normal text-black lg:text-xl xl:text-2xl dark:text-gray-300">
              ...
              and solutions to ensure compliance with accessibility guidelines
